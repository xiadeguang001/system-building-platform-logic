...
public class PmsUtil {
    ...
    public static String saveErrorTxtByList(List<String> msg, String name) {
        Date d = new Date();
        String saveDir = "logs" + File.separator + DateUtil.yyyyMMddLocal.get().format(d) + File.separator;
        ...
        name += DateUtil.yyyymmddhhmmssLocal.get().format(d) + Math.round(Math.random() * 10000);
