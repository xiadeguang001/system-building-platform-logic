...
public class DataAutorUtils {
    ...
    public static synchronized List<SysPermissionDataRuleModel> loadDataSearchConditon() {
        return (List<SysPermissionDataRuleModel>) SpringContextUtil.getHttpServletRequest().getAttribute(MENU_DATA_AUTHOR_RULES);
    ...
    public static synchronized String loadDataSearchConditonSQLString() {
        return (String) SpringContextUtil.getHttpServletRequest().getAttribute(MENU_DATA_AUTHOR_RULE_SQL);
    }
    ...
    public static synchronized SysUserCacheInfo loadUserInfo() {
        return (SysUserCacheInfo) SpringContextUtil.getHttpServletRequest().getAttribute(SYS_USER_INFO);
