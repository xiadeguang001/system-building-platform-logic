package com.haso.system.aspect;
...
public class DictAspect {
    ...
    // 定义切点Pointcut
    @Pointcut("execution(public * com.haso..*.*Controller.*(..))")
        ...
        if (result instanceof Result) {
            ...
            // 集合型
                ...
                for (Object record : resultList) {
                	if (record instanceof String) return;
                	items.add(translateObject(record));
                }
    ...
    private JSONObject translateObject(Object obj) {
        ...
        for (Field field : OConvertUtil.getAllFields(obj)) {
