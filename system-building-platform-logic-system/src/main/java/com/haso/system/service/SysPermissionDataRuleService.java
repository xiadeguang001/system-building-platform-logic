 ...
 */
@Service
public class SysPermissionDataRuleService extends ServiceImpl<SysPermissionDataRuleMapper, SysPermissionDataRule> {
	...
	public List<SysPermissionDataRule> queryPermissionDataRules(String username,String permissionId) {
		...
		for (String ids : idsList) {
			...
			for (String id : arr) {
				if(OConvertUtil.isNotEmpty(id) && !set.contains(id)) {
					set.add(id);
				}
			}
		}
