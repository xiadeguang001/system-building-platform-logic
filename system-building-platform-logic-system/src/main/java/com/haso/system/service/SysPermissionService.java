...
import com.haso.system.mapper.SysPermissionMapper;
...
public class SysPermissionService extends ServiceImpl<SysPermissionMapper, SysPermission> {
	...
	public void deletePermission(Integer id) throws AppException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new AppException("未找到菜单信息");
		}
		Integer pid = sysPermission.getParentId();
		if(OConvertUtil.isNotEmpty(pid)) {
	...
	public void deletePermissionLogical(Integer id) throws AppException {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new AppException("未找到菜单信息");
		}
...
//	//@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	 ...
	 */
	public void deletePermRuleByPermId(Integer id) {
