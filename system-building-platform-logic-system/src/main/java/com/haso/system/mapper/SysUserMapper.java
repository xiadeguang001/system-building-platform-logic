...
public interface SysUserMapper extends BaseMapper<SysUser> {
	 ...
	 * @return
	 */
	IPage<SysUser> selUserList(IPage<SysUser> page, @Param("user") SysUser user, @Param("column") String column, @Param("order") String order);
	 ...
	 * @return
	 */
	List<SysUserDepVo> getDepNamesByUserIds(@Param("userIds") List<Integer> userIds);
...
//	 * @return 查询结果
//	 */
//	IPage<LookupUserView> selUserView(IPage<LookupUserView> page, @Param("userView") LookupUserView userView);
