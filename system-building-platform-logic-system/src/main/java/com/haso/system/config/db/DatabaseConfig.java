...
@Configuration
@MapperScan(value={"com.haso.**.mapper*"}, sqlSessionFactoryRef = "sqlSessionFactoryBean")
...
//        dataSource.setMaxPoolPreparedStatementPerConnectionSize(maxPoolPreparedStatementPerConnectionSize);
        ...
        stDataSource.setUniqueResourceName("datasource");
//        return stDataSource;
//                DataSourceBuilder builder = DataSourceBuilder.create();
//        builder.type(HikariDataSource.class);
//        return builder.build();
...
//    }
    ...
    public SqlSessionFactory sqlSessionFactoryBean(@Qualifier("datasource") DataSource datasource) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath*:com/haso/**/mapper/xml/*.xml"));
