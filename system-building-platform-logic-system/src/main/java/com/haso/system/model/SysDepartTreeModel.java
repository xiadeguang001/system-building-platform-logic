...
public class SysDepartTreeModel implements Serializable{
	...
	public SysDepartTreeModel(SysDepart sysDepart) {
		this.key = ConvertUtil.getString(sysDepart.getId());
        this.value = ConvertUtil.getString(sysDepart.getId());
        this.title = sysDepart.getDepartName();
        this.id = ConvertUtil.getString(sysDepart.getId());
        this.parentId = ConvertUtil.getString(sysDepart.getParentId());
