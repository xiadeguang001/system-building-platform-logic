...
public class TreeModel implements Serializable {
	...
	public TreeModel(SysPermission permission) {
		this.key = ConvertUtil.getString(permission.getId());
		this.icon = permission.getIcon();
		this.parentId = ConvertUtil.getString(permission.getParentId());
		this.title = permission.getName();
		this.slotTitle =  permission.getName();
		this.value = ConvertUtil.getString(permission.getId());
