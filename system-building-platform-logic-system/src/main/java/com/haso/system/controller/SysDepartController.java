...
import com.haso.system.service.SysDepartService;
 ...
 * <p>
 * 
 * @Author: prwang @Since： 2020-04-17
 */
@RestController
...
public class SysDepartController {
	...
	public Result<List<SysDepartTreeModel>> queryMyDeptTreeList() {
		...
		try {
			if(OConvertUtil.isNotEmpty(user.getIdentity()) && user.getIdentity() == CommonConstant.USER_IDENTITY_2 ){
