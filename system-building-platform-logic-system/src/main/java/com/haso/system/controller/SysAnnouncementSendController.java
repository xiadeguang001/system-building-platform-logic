...
public class SysAnnouncementSendController {
	...
	public Result<SysAnnouncementSend> editById(@RequestBody JSONObject json, HttpServletRequest request) {
		Result<SysAnnouncementSend> result = new Result<SysAnnouncementSend>();
	...
	public Result<SysAnnouncementSend> readAll(HttpServletRequest request) {
		Result<SysAnnouncementSend> result = new Result<SysAnnouncementSend>();
		String currentUserName = JwtUtil.getUsername(request.getHeader("X-Access-Token"));
		SysUser sysUser = sysUserService.getUserByName(currentUserName);
		String userId = ConvertUtil.getString(sysUser.getId());
